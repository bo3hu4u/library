...
import lib_group.library.controllerstest.AuthorControllerTest;
import lib_group.library.controllerstest.BookControllerTest;
import lib_group.library.servicestest.LocationServiceTest;
import lib_group.library.controllerstest.PublishingHouseControllerTest;
import    models.*;
...
public class LibraryApplicationTests {
    ...
    public void startTest() {
        ...
        ph.setBooks(bookService.findBooksByTitleIn(Arrays.asList("book1", "book3")));
        publishingHouseService.save(ph);
